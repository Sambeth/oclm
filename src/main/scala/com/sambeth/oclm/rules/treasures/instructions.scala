...
trait AssignSpiritualGems[M]:
  extension (m: M)
    def assignSpiritualGems: SpiritualGems

given assignElderSpiritualGems: AssignSpiritualGems[Elder] with
  extension(m: Elder)
    def assignSpiritualGems: SpiritualGems = SpiritualGems(m)
