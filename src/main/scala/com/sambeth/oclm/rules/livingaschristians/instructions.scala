...
trait AssignCongregationBibleStudy[M]:
  extension (m: M)
    def assignCongregationBibleStudy: CongregationBibleStudy

given assignElderCongregationBibleStudy: AssignCongregationBibleStudy[Elder] with
  extension(m: Elder)
    def assignCongregationBibleStudy: CongregationBibleStudy = CongregationBibleStudy(m)


// ad hoc
trait AssignAdHoc[M]:
  extension (m: M)
    def assignAdHoc(title: String): AdHoc

given assignElderAdHoc: AssignAdHoc[Elder] with
  extension(m: Elder)
    def assignAdHoc(title: String): AdHoc = AdHoc(title, m)
